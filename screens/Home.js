...
export default function Home() {
  ...
  return todos.length > 0 ? (
    <ScrollView style={styles.container}>
      ...
      >
        <Text style={styles.title}>Hoy dia</Text>
        <TouchableOpacity onPress={handleHideCompleted}>
          <Text style={{ color: "#3478F6" }}>
            {isHidden ? "Mostrar completada" : "Ocultar completados"}
          </Text>
        </TouchableOpacity>
      </View>
      {todayTodos.length > 0 ? (
        ...
        >
          <Image
            source={require("../assets/simp.gif")}
            style={{
              width: 150,
              height: 150,
              marginBottom: 20,
          ...
          <Text style={{ fontSize: 13, color: "#737373", fontWeight: "500" }}>
            No tienes ninguna tarea, disfruta tu día.
          </Text>
        </View>
      )}
